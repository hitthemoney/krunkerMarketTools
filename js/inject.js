...
<div id="pingStyleSwitch"><label class="switch"><input type="checkbox" id="pingStyleCheckbox"><span
			...
			window.showSettings = function () {
				...
				let settings = document.getElementById("settings");
				let buttons = ["leaders", "profile", "maps", "market", "tourney", "virus"];
	...
	var mainScript = document.getElementsByTagName("script")[10].innerText,
    mScriptM = (((("var fObj = {};" + mainScript.slice(0, -4)).replace(',Object.defineProperty(window,"captchaCallback",{writeable:!1,value:function(){o.connect(l.socialURL+"/ws",(function(e){e||(z&&U?(profileLogin.style.display="none",profileName.innerHTML=D.get("social.login.proccessing"),ae=!0,o.send("a",[z,null,U])):(profileLogin.style.display="inline-block",profileName.innerHTML=""),Je(r,n,F,z,i,W,s),k=!0)}),{0:ne,1:ke,a:re,pi:Xe,po:xe,br:Se,fr:fe,str:ge,psd:We,ulir:_e,lir:Oe,gir:Be,rpr:we,rps:le,fgr:he,verr:ve,gd:Ge,vd:Ue,trD:Ce,trR:Ie,spR:Ve,dbE:function(){},pir:function(){}})}}),updateWindow($("p"),$("q"),$("s"),$("i"))', "")).split("window.").join("fObj."))).split("fObj.activeHacker").join("window.activeHacker").split("fObj.location").join("window.location") + "window.a = a}]);",
	mScriptMFunc = eval(mScriptM);
	window.estimateValue = a(92).estimateValue;
	const skins = a(61).skins;
